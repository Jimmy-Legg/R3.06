...
#echo -e "\033[0;33m> Test de la connexion entre l'administration et le serveur S en SMTP (tcp port 25)\033[0;0m"
#nping -c 1 --tcp --dest-port 1234 --source-port 1234 --dest-ip 172.12.150.1

#echo -e "\033[0;33m> Test de la connexion entre l'administration et le mailer en SMTP (tcp port 25)\033[0;0m"
...
#echo -e "\033[0;33m> Test de la connexion entre l'administration et internet via HTTP (tcp port 80) \033[0;0m"
#nping -c 1 --tcp --dest-port 80 --source-port 80 --dest-ip google.fr

#echo -e "\033[0;33m> Test de la connexion entre l'administration et internet via HTTPS (tcp port 443) \033[0;0m"
